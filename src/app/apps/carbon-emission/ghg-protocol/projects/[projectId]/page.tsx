...
import { GHGProtocolCalculationDialog } from '@/components/ghg-protocol/ghg-protocol-calculation-dialog';
import { GHGProtocolCalculationsTable } from '@/components/ghg-protocol/ghg-protocol-calculations-table';
...
export default function GHGProtocolProjectDetailPage() {
  ...
  const { data: projectData, isLoading: projectLoading } =
    trpc.ghgProtocolProjects.getById.useQuery(
      { id: projectId },
      { enabled: !!projectId }
    );
  ...
  } = trpc.ghgProtocolCalculations.getByProjectId.useQuery(
    { projectId },
    { enabled: !!projectId }
  );
    ...
    return (
      <Empty>
        <EmptyHeader>
          ...
          <EmptyDescription>
            The GHG Protocol project you&apos;re looking for doesn&apos;t exist
            or has been removed.
          </EmptyDescription>
        </EmptyHeader>
      </Empty>
