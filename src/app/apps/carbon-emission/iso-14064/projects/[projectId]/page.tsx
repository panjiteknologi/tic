...
import { ISO14064CalculationDialog } from '@/components/iso-14064/iso-14064-calculation-dialog';
import { ISO14064CalculationsTable } from '@/components/iso-14064/iso-14064-calculations-table';
...
export default function ISO14064ProjectDetailPage() {
  ...
  const { data: projectData, isLoading: projectLoading } =
    trpc.iso14064Projects.getById.useQuery(
      { id: projectId },
      { enabled: !!projectId }
    );
  ...
  } = trpc.iso14064Calculations.getByProjectId.useQuery(
    { projectId },
    { enabled: !!projectId }
  );
    ...
    return (
      <Empty>
        <EmptyHeader>
          ...
          <EmptyDescription>
            The ISO 14064-1:2018 project you&apos;re looking for doesn&apos;t
      ...
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div className="space-y-2">
          ...
          <div className="flex items-center gap-4 text-sm text-muted-foreground">
            ...
            <div className="flex items-center gap-1">
              <FileText className="h-4 w-4" />
              Boundary: {project.boundaryType}
            </div>
          </div>
        </div>
        <ISO14064CalculationDialog
          projectId={projectId}
