  ...
  create: protectedProcedure
    ...
    .mutation(async ({ ctx, input }) => {
      try {
        ...
        console.log("Activity data created successfully, calculation will be done separately via frontend");
  ...
  update: protectedProcedure
    ...
    .mutation(async ({ input }) => {
      try {
        ...
        console.log("Activity data updated successfully, recalculation will be done separately if needed");
