...
type ISO14064CalculationFormData = {
...
interface ISO14064CalculationDialogProps {
  projectId: string;
  open: boolean;
...
export function ISO14064CalculationDialog({
  projectId,
  open,
  setOpen,
  onSuccess,
  onError
}: ISO14064CalculationDialogProps) {
  const [formData, setFormData] = useState<ISO14064CalculationFormData>({
    scope: 'Scope1',
    category: '',
    quantity: '',
    unit: '',
  ...
  const createMutation = trpc.iso14064Calculations.create.useMutation({
    onSuccess: () => {
      setIsSubmitting(false);
      setOpen(false);
      resetForm();
      utils.iso14064Calculations.getByProjectId.invalidate({ projectId });
      utils.iso14064Projects.getById.invalidate({ id: projectId });
      onSuccess();
    },
        ...
        <form onSubmit={handleSubmit}>
          <DialogHeader>
            <DialogTitle className="flex items-center gap-2">
              ...
              New ISO 14064-1:2018 Calculation
            </DialogTitle>
            <DialogDescription>
              ...
              <div className="grid gap-2">
                ...
                <Select
                  ...
                  onValueChange={(value: any) =>
                    setFormData({ ...formData, gasType: value })
                  }
                >
                  <SelectTrigger>
                  ...
                  <SelectContent>
                    <SelectItem value="">Auto-detect (AI will choose)</SelectItem>
