...
type ISO14064Calculation =
  inferRouterOutputs<AppRouter>['iso14064Calculations']['getByProjectId']['calculations'][number];

interface ISO14064CalculationsTableProps {
  projectId: string;
  calculations: ISO14064Calculation[];
  onCalculationDeleted: () => void;
}

export function ISO14064CalculationsTable({
  projectId,
  calculations,
  onCalculationDeleted
}: ISO14064CalculationsTableProps) {
  const [selectedCalculation, setSelectedCalculation] =
    useState<ISO14064Calculation | null>(null);
  ...
  const deleteMutation = trpc.iso14064Calculations.delete.useMutation({
    onSuccess: () => {
  ...
  const handleViewDetails = (calculation: ISO14064Calculation) => {
